  ...
  return (
    <div className="max-w-3xl">
      ...
      <div className="flex items-start justify-between mb-6">
        <div>
          <h1 className="text-2xl font-bold text-gray-900">{r.job_title}</h1>
          {r.company_name && (
      ...
      {r.status === "failed" && (
        <div className="p-4 bg-red-50 border border-red-200 rounded-lg mb-6">
          <p className="text-red-700 font-medium">Tailoring failed</p>
          {r.error_message && (
            <p className="text-red-600 text-sm mt-1">{r.error_message}</p>
          )}
        </div>
      )}
